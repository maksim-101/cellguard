    ...
    static func seed(into context: ModelContext) {
        ...
        for (i, latency) in stride(from: 90.0, through: 430.0, by: 28.0).enumerated() {
            events.append(ConnectivityEvent(
                ...
                interfaceType: .cellular, radioTechnology: nr, carrierName: "Swisscom",
        ...
        for (i, kbps) in [42000.0, 31000.0, 18500.0, 9200.0].enumerated() {
            events.append(ConnectivityEvent(
                ...
                interfaceType: .cellular, radioTechnology: nr, vpnState: .connected, vpnInterface: "utun6",
        ...
        for i in 0..<4 {
            events.append(ConnectivityEvent(
                ...
                interfaceType: .cellular, radioTechnology: nr,
        ...
        for i in 0..<2 {
            events.append(ConnectivityEvent(
                ...
                interfaceType: .cellular, radioTechnology: nr, probeLatencyMs: 10000 + Double(i * 5),
